...
Replace this section with the supported versions for `fixturemint`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `fixturemint` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in fixturemint.
